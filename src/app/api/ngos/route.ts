  ...
  try {
    ...
    const created = await prisma.nGO.create({
      data: {
        ...
        serviceAreas: parsed.serviceAreas ? JSON.stringify(parsed.serviceAreas) : undefined,
        capacityPerDay: parsed.capacityPerDay ?? null,
        preferredDonations: parsed.preferredDonations ? JSON.stringify(parsed.preferredDonations) : undefined,
